...
<head>
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('favicon/LOGOWEB.png') }}">
    <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('favicon/LOGOWEB.png') }}">
    <link rel="apple-touch-icon" sizes="60x60" href="{{ asset('favicon/LOGOWEB.png') }}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('favicon/LOGOWEB.png') }}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('favicon/LOGOWEB.png') }}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('favicon/LOGOWEB.png') }}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('favicon/LOGOWEB.png') }}">
    <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('favicon/LOGOWEB.png') }}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('favicon/LOGOWEB.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('favicon/LOGOWEB.png') }}">
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('favicon/LOGOWEB.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('favicon/LOGOWEB.png') }}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{ asset('favicon/LOGOWEB.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('favicon/LOGOWEB.png') }}">
    <link rel="manifest" href="{{ asset('favicon/manifest.json') }}">
    <meta name="msapplication-TileColor" content="#fff">
    <meta name="theme-color" content="#0191D7">
    <meta name="msapplication-TileImage" content="{{ asset('favicon/LOGOWEB.png') }}">
